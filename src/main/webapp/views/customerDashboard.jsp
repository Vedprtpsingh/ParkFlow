...
<body>
    ...
    <div class="container">
        ...
        <div class="user-profile">
            ...
            <p>User ID: <c:out value="${userId}" default="N/A"/></p>
            <p>Email: <c:out value="${userEmail}" default="N/A"/></p>
        ...
        <div class="card mt-3">
            ...
            <div class="features-grid">
                <a href="/parkflow/addVehicle" class="feature-card" title="Register a new vehicle">
                    <i class="fas fa-plus-circle"></i>
                    <h3>Add Vehicle</h3>
                    <p>Register a new vehicle</p>
                </a>
                <a href="/parkflow/parkVehicle" class="feature-card" title="Assign a parking slot">
                ...
                <a href="/parkflow/parkflowmap" class="feature-card" title="View occupancy map">
                    <i class="fas fa-map-marked-alt"></i>
                    <h3>Parking Map</h3>
                    <p>View occupancy map</p>
                </a>
                <a href="/parkflow/parkVehicle" class="feature-card" title="Book Parking Slot">
